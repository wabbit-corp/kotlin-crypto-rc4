...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-crypto-rc4", "1.2.0")
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-crypto-rc4")
        description.set("kotlin-crypto-rc4")
        url.set("https://github.com/wabbit-corp/kotlin-crypto-rc4")
        licenses {
            license {
        ...
        scm {
            url.set("https://github.com/wabbit-corp/kotlin-crypto-rc4")
            connection.set("scm:git:git://github.com/wabbit-corp/kotlin-crypto-rc4.git")
            developerConnection.set("scm:git:ssh://git@github.com/wabbit-corp/kotlin-crypto-rc4.git")
        }
    }
}
...
dokka {
    moduleName.set("kotlin-crypto-rc4")
    ...
    dokkaSourceSets.configureEach {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-crypto-rc4/tree/master/src")
