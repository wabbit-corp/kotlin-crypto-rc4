...
kover {
    ...
    //             // title.set("kotlin-crypto-rc4 Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-crypto-rc4/tree/master/src/main/kotlin")
